<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-plus"></i> Periode Pemilihan</li>
      </ol>
    </section>
...
<div class="box box-secondary">
    <div class="box-header with-border">
        Data Periode Pemilihan.
        <div class="pull-right">
            <a href="<?=base_url()?>periode/form" class="btn btn-success"><i class="fa fa-plus"></i></a>
        </div>
