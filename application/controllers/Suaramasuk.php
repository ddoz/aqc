...
class Suaramasuk extends CI_Controller {
	...
	public function index()
	{
        ...
        $this->db->join("kandidat","kandidat.id=suara_masuk.kandidat_id");
        $this->db->join("periode","periode.id=suara_masuk.periode_id");
        $suara_masuk = $this->db->get('suara_masuk')->result();
        $data = array(
            'script'    => 'script/js_jadwal',
            'page'      => 'suara_masuk/index',
            'link'      => 'suaramasuk',
            'table'     => $suara_masuk
        );
